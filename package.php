...
<head>
   ...
   <title>Find and Choose Your Time</title>
...
<section class="header">
   ...
   <nav class="navbar">
      ...
      <a href="package.php" class="active">Timing</a>
...
{   
    ...
    else
    {
            ...
            <script>setTimeout(function(){window.location.href ="package.php";}, 3000);
            </script>
            <?php
    }
}
...
<div class="heading" style="background:url(images/bus14.jpg) no-repeat;">
		<a href="bus details.php" class="btn" style="margin-right: 10px;">See Schedule</a>				
		<a href="find_bus.php" class="btn">Find Buses</a>
</div>

<div id="white-bar" class="fas fa-bars"></div>
...
<section class="packages">
   ...
   <h1 class="heading-title">Book For Private Use</h1>
...
<a href="privet.php" class="btn" style="margin-left:45%">more</a>
